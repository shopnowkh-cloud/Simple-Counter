...
IK_MAIN  = mkb([[IKB("✍️ រចនាប័ទ្មអក្សរ",callback_data="style"),IKB("🗂️ បំប្លែង PDF",callback_data="doc")],[IKB("📷 QR Code",callback_data="qr"),IKB("🥇 ហាងឆេងមាស",callback_data="gold")],[IKB("🎙️ បង្កើតសំឡេង Ai",url="https://t.me/limsovannradybot?start=start")]])
